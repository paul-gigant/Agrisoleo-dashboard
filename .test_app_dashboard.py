...
app.layout = html.Div(children=[
    ...
    html.Div(children= [
        ...
        dcc.RadioItems(
            id = "parameter_choice",
            options=[{'label':'Azimut','value': 'azimut'},{'label':'Ecart inter-rang','value': 'xgap_module'},{'label':'Pilotage','value': 'backtracking'}],
            value = 'azimut',
            inline=True,
            ),
...
def select_data_use_for_display(period,parameter,pilotage,azimut,ecart,units):
    ...
    df = df_periode2
    if parameter == 'azimut':
        mask = (df['backtracking']==pilotage) &  (df['xgap_module']==ecart)
    elif parameter == 'xgap_module':
        mask = (df['backtracking']==pilotage) &  (df['azimut']==azimut)
    elif parameter == 'backtracking':
        mask = (df['xgap_module']==ecart) &  (df['azimut']==azimut)
